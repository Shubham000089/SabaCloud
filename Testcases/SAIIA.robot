...
${Org_URL}    https://iea-nosso.sabacloud.com/Saba/Web_spf/NA10P1PRD040/app/team/shared;spf-url=common%2Fteam%2Fteamhome%2Fxxemptyxx%2ForgAdmin%2Fbisut000000000003189
${Sheet_name}    ../Extracted Excel/SAIIA.xlsx
${start}      RANDALL MOODY    # Set name here if you have to start the script using broken keyword.
${name_of_org}    SAIIA        # This will not required if you are not downloading attachments.
...
Data from SabaCloud
    ...
    FOR    ${i}     IN RANGE    ${MAX_RETRIES}
        ...
        TRY
            ...
            ${length} =     Get Length    ${Temp_Employee_list}
            ${length} =     Run Keyword If    ${length} > 1    Evaluate    ${length} - 1
            ${emp_name} =    Run Keyword If    ${length} > 0     Get From List    ${Temp_Employee_list}   ${length}
