...
#Next Button
#    [Arguments]    ${j}
#    [Documentation]    Not Used commenting temp
#    Run Keyword If    (${j} % 10 == 1)        Click Element After Visible    ${B_NEXT}
#    Wait Until Element Is Visible    ${LOADING}    timeout=10
#    Wait Until Element Is Not Visible    ${LOADING}    timeout=10
...
Preloop for certification
    ...
    Select Frame    ${IFRAME}
    Sleep    0.5
    Wait Until Element Is Visible    ${C_COMPLETED}    timeout=10
